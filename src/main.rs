...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/proposals/:id",                  delete(routes::proposals::delete_proposal))
        .route("/api/proposals/:id/dates",             post(routes::proposals::add_date_option))
        .route("/api/proposals/:id/vote",             post(routes::proposals::vote))
        .route("/api/proposals/:id/vote",             delete(routes::proposals::unvote))
        // Users
